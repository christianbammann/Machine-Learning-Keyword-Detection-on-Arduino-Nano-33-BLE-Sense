...
// Provides the quantization parameters from the model input tensor. The Python
// model was quantized after STFT preprocessing, so generated magnitudes need to
// be quantized with the model's own input scale and zero point.
